...
<head>
<meta charset="UTF-8">
<?php require '../../../sesiones/sesionbps.php'; ?>
...
switch ($extra){
    case 1: 
    $ingredientes=$ingredientes." Extra: "." Orilla de Queso";
    $precio=$precio+10;
    break;
    case 2:
    $ingredientes=$ingredientes." Extra: "." Extra Queso";
    $precio=$precio+10;
    break;
    case 3:
    $ingredientes=$ingredientes." Extra: "." Extra Queso"." "." Orilla de Queso";
    $precio=$precio+18;
}
?>
<body>
...
<textarea class="form-control rounded-0" id="exampleFormControlTextarea2" rows="4" readonly="readonly"><?php  echo $ingredientes;?></textarea>
</div>
<div class="col-sm-6">
...
<input type="number" class="form-control"class="form-control" name="total" id="total" value="<?php  echo $precio;?>" readonly="readonly">
</div>
<div class="col-sm-6">
