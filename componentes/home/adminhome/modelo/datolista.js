    ...
    var table= $("#dt_cliente").DataTable({
      ...
      "url": "//cdn.datatables.net/plug-ins/1.10.15/i18n/Spanish.json"
        ...
        "columns":[
            ...
            {"data" : "email_cliente"},
            {"defaultContent":"<button type='button' class='editar btn btn-primary'data-toggle='modal' data-target='#upusuarios1' style='width:35px; height:30px'><i class='fa fa-pencil-square-o'></i></button> <button type='button' style='width:35px; height:30px' class='eliminar btn btn-danger btn-xs' data-toggle='modal' data-target='#modalEliminar' ><i class='fa fa-trash-o'></i></button>"}
        ]
    });
