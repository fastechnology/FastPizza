    ...
    var table= $("#dt_ventas").DataTable({
      ...
      "url": "//cdn.datatables.net/plug-ins/1.10.15/i18n/Spanish.json"
        ...
        "columns":[
            ...
            {"data" : "total"},
            {"data" : "estadopizza"},
            {"defaultContent":"<button type='button' class='editarv btn btn-primary btn-xs 'data-toggle='modal' data-target='#ActulizarVenta1'><i class='fa fa-pencil-square-o'></i></button> <button type='button' class='eliminarv btn btn-danger btn-xs' data-toggle='modal' data-target='#modaleliminarventa' ><i class='fa fa-trash-o'></i></button>"}
